...
template <class T> inline void multiply(T *out, const T *in1, const T *in2) {
  ...
  // out[0] =  in2[0] * in1[3] - in2[1] * in1[2] + in2[2] * in1[1] + in2[3] *
  // in1[0];
  // out[1] =  in2[0] * in1[2] + in2[1] * in1[3] - in2[2] * in1[0] + in2[3] *
  // in1[1];
  // out[2] = -in2[0] * in1[1] + in2[1] * in1[0] + in2[2] * in1[3] + in2[3] *
  // in1[2];
  // out[3] = -in2[0] * in1[0] - in2[1] * in1[1] - in2[2] * in1[2] + in2[3] *
  // in1[3];
